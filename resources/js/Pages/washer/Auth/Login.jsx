        ...
        <div className="flex min-h-screen font-kanit">
            ...
            <div className="hidden lg:flex w-1/2 bg-[url('/washerAccPic/pc3.jpg')] bg-cover bg-center">
                <div className="h-full w-full bg-blue-400 bg-opacity-50 flex flex-col items-center justify-center text-white text-center p-8">
                    ...
                    >
                        We're looking for passionate and dedicated individuals
                        to join our team and help deliver excellent car wash and
                        detailing services to our customers.
                    </motion.p>
                    ...
                    <motion.p
                        ...
                        className="mt-4 text-lg max-w-md"
                    >
                        If you're ready to work in a dynamic environment and
                    ...
                    >
                        ...
                        >
                            ...
                            <p className="text-sm">Opportunities to Advance</p>
                        </motion.div>
                        ...
                        >
                            ...
                            <p className="text-sm">Fair Compensation</p>
                        </motion.div>
                    </motion.div>
