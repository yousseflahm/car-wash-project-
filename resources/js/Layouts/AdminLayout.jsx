...
export default function AdminAuthentificatedLayout({ children }) {
        ...
        <>
            <div className="font-kanit">
                            ...
                            >
                                <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                                    ...
                                    <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-blue-200 px-6 pb-4 ring-1 ring-white/10" >
                                        <div className="flex h-16 my-4 pl-6 shrink-0 items-center">
                                            <ApplicationLogo />
                                        </div>
                ...
                <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
                    {/* Sidebar component, swap this element with another sidebar if you like */}
                    <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-opacity-75 px-6 pb-4 bg-blue-200" >
                        <div className="flex h-16 my-4 pl-6 shrink-0 items-center">
                            <ApplicationLogo />
                        </div>
